# -*- coding: utf-8 -*-
"""
Created on Sun Mar 3 03:21:53 2019
...
def create_output_frame(offcenter, pts, undist_ori, fps, curvature, curve_direction, binary_sub, threshold=0.3):
    ...
    if abs(offcenter) > threshold:  # car is offcenter more than 0.3 m
        # Draw Red lane
        cv2.fillPoly(color_warp, np.int_([pts]), (0, 0, 255))#blue
        counter=counter+1
        if counter==50:
            ic=ic+1  
            print()
    ...
    info_warning = "Warning: offcenter > 0.3"
